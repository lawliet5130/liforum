...
<div class="menu_home">
	<div class="container">
		...
		<div class="col-md-5 login_head_container">
            ...
            @elseif(\Auth::guard('fb')->check())
                @php $profile_data=\Auth::guard('fb')->user(); @endphp
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle img_header_avatar_a" data-toggle="dropdown">
                            <span class="alert_messages hidden">3</span>
                            <img src="/storage/{{$profile_data->avatar}}" alt="" class="img_header_avatar">
                        </a>
                        <ul class="dropdown-menu card_user">
                            <li>
                                <div class="navbar-login">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <p class="text-center">
                                                <img src="/storage/{{$profile_data->avatar}}" alt="" class="img_header_avatar_card">
                                            </p>
                                        </div>
                                        <div class="col-lg-8">
