<tr class="itemHimself">
	...
	<td class="action_delete">
		<a href="" data-item="works" data-itemid="{{$item->id}}" data-itemtitle="{{$item->title}}" data-itemtext="{{$item->text}}" data-itembranch="{{$item->branch_id}}" data-itemlink="{{$item->link}}" class="editOpen action_buttons edit_button" data-toggle="modal" data-target="#edit-modal" >
